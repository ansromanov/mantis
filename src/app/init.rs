...
impl App {
    ...
    pub fn new(
        ...
        let mut app = App {
            ...
            show_help: false,
            help_scroll: crate::scroll::ScrollState::new(),
            help_tab: 0,
            ...
            history_offset: 0,
            repo_log_area: ratatui::layout::Rect::default(),
            repo_log_offset: 0,
            ...
            filter_cache: RefCell::new(std::collections::HashMap::new()),
            filter_bar: None,
            session_dirty: false,
