...
impl Keymap {
    ...
    fn bindings_for_action(&self, action_id: &str) -> &[KeyBinding] {
        match action_id {
            ...
            "toggle_table_view" => &self.toggle_table_view,
...
pub struct Keymap {
    ...
    pub toggle_table_view: Vec<KeyBinding>,
    ...
    pub toggle_bookmark: Vec<KeyBinding>,
    pub bookmarks: Vec<KeyBinding>,
...
impl Default for Keymap {
    ...
    fn default() -> Self {
        ...
        let mut map = Keymap {
            ...
            toggle_table_view: Vec::new(),
            toggle_blame: bind(&["ctrl+b"]),
            blame_line: bind(&["content:B"]),
            toggle_diff_side_by_side: bind(&["S"]),
            ...
            toggle_bookmark: bind(&["tree:B"]),
            bookmarks: bind(&["tree:b"]),
